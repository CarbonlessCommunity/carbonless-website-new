...
export const solutions: Solution[] = [
  {
    ...
    image: asset('/images/ucapture.png'),
  ...
  },
  {
    ...
    image: asset('/images/Nexamp_1.jpeg'),
    logo: asset('/images/nexamp_logo.jpeg'),
  ...
  },
  {
    ...
    image: asset('/images/auction.png'),
    logo: asset('/images/satori.jpg'),
  ...
  },
  {
    ...
    logo: asset('/images/200px-Energy_Star_logo.svg.png'),
  },
  {
    slug: 'efficient-cars',
    ...
    image: asset('/images/go-green-transportation-car.jpg'),
  },
  {
    slug: 'enerfusion',
    name: 'EnerFusion',
    ...
    image: asset('/images/orion.jpg'),
    logo: asset('/images/enerfusion company logo 14d.png'),
  ...
  },
  {
    ...
    image: asset('/images/XLPage.jpg'),
    logo: asset('/images/XLlogo.png'),
  },
  {
    slug: 'qcoefficient',
    name: 'QCoefficient',
    ...
    image: asset('/images/qlogoBlue.png'),
    // qlogo.png is the white knockout — unusable on the white logo plate
    logo: asset('/images/qlogoBlue.png'),
  },
]

export const offsetProjects = [
  { image: asset('/images/offsets1.png'), url: 'https://www.ucapture.com/projects/rwanda', name: 'Rwanda' },
  { image: asset('/images/offsets2.png'), url: 'https://www.ucapture.com/projects/isangi', name: 'Isangi' },
  { image: asset('/images/offsets3.png'), url: 'https://www.ucapture.com/projects/bearcreek', name: 'Bear Creek' },
  { image: asset('/images/offsets4.png'), url: 'https://www.ucapture.com/projects/southkent', name: 'South Kent' },
  { image: asset('/images/offsets5.png'), url: 'https://www.ucapture.com/projects/khonburi', name: 'Khon Buri' },
  { image: asset('/images/offsets6.png'), url: 'https://www.ucapture.com/projects/seneca', name: 'Seneca' },
]
